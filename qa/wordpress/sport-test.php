...
pruefe('bestaetigtes Ergebnis wird letztes Spiel', $r['last_match']['score'] ?? null, '3 : 2');
pruefe('Datum lesbar formatiert', $r['last_match']['date'] ?? null, '13.09.2026 · 15:00 Uhr');
pruefe('naechstes Spiel uebernommen', $r['next_match']['home'] ?? null, 'SC Jülich 1910/97/Hoengen');
...
pruefe('sondern pending', $r2['pending_match']['home'] ?? null, 'SC Merzenich');
