...
const SCHREIBEN = ['meldungen', 'marke', 'symbolbilder', 'markt-prerender', 'sport-prerender', 'suche-index', 'thema-prerender',
  'teaser-bilder', 'ortsmarke', 'inhaltsindex', 'termine-prerender', 'ressort-menue', 'unternehmen', 'anzeigen', 'foto-des-tages', 'anzeigen-assistent', 'kopf-theme-einbinden'];
const PRUEFEN = ['symbolbilder', 'markt-prerender', 'sport-prerender', 'suche-index', 'thema-prerender', 'teaser-bilder', 'ortsmarke',
  'meldungen', 'marke', 'ressort-menue', 'inhaltsindex', 'termine-prerender', 'unternehmen', 'anzeigen', 'foto-des-tages', 'anzeigen-assistent', 'kopf-theme-einbinden'];
